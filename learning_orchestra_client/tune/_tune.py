...
class Tune:
    ...
    def create_tune_sync(self,
            ...
            Union[dict, str]:
        """
        description: This method is responsible to tune models in sync mode

        pretty_response: If true it returns a string, otherwise a dictionary.
        name: Is the name of the tune output object that will be created.
    ...
    def create_tune_async(self,
            ...
            Union[dict, str]:
        """
        description: This method is responsible to tune models in async mode.
    ...
    def search_all_tunes(self, pretty_response: bool = False) \
            -> Union[dict, str]:
        """
        description: This method retrieves all tune metadata, i.e., it does
        not retrieve the tune content.
    ...
    def delete_tune(self, name: str, pretty_response=False) \
            -> Union[dict, str]:
        """
        description: This method is responsible for deleting the tune step.
    ...
    def search_tune_content(self,
            ...
            -> Union[dict, str]:
        """
        description:  This method is responsible for retrieving all the tune
        tuples or registers, as well as the metadata content

        pretty_response: If true it returns a string, otherwise a dictionary.
        name: Is the name of the tune object
        query: Query to make in MongoDB(default: empty query)
        limit: Number of rows to return in pagination(default: 10) (maximum is
        set at 20 rows per request)
        skip: Number of rows to skip in pagination(default: 0)

        return: A page with some tunes inside or an error if there
        is no such tune object. The current page is also returned to be used in
    ...
    def wait(self, name: str, timeout: int = None) -> dict:
        """
           ...
           barrier for the create_tune_async method, delete_tune method.

           name: Represents the tune name.
           timeout: Represents the time in seconds to wait for a tune to
           finish its run.
